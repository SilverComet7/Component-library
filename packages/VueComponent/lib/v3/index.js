import { openBlock, createElementBlock, createElementVNode, warn, getCurrentInstance as getCurrentInstance$1, computed as computed$1, ref as ref$1, inject, unref as unref$1, watch as watch$1, onMounted, watchEffect, onBeforeUnmount, isRef, onScopeDispose as onScopeDispose$1, defineComponent, mergeProps, renderSlot, provide, nextTick, useSlots, Text, normalizeClass, normalizeStyle, Fragment, createBlock, withCtx, resolveDynamicComponent, createCommentVNode, reactive, toRef, createVNode, h, withModifiers, toDisplayString, Teleport, Transition, withDirectives, createSlots, vShow, createTextVNode } from "vue";
import { ref, getCurrentScope, onScopeDispose, unref, getCurrentInstance, isVue2, watch, computed } from "vue-demi";
var _a;
...
const useSize = (fallback, ignore = {}) => {
  ...
  return computed$1(() => size.value || unref$1(fallback) || (formItem == null ? void 0 : formItem.size) || (form == null ? void 0 : form.size) || globalConfig2.value || "");
};
...
usage: app.provide(ID_INJECTION_KEY, {
  ...
  const idRef = computed$1(() => unref$1(deterministicId) || `el-id-${idInjection.prefix}-${idInjection.current++}`);
  return idRef;
};
const useFormItem = () => {
  const form = inject(formContextKey, void 0);
...
const buildLocaleContext = (locale) => {
  const lang = computed$1(() => unref$1(locale).name);
...
const useNamespace = (block) => {
  ...
  const b = (blockSuffix = "") => _bem(unref$1(namespace), block, blockSuffix, "", "");
  const e = (element) => element ? _bem(unref$1(namespace), block, "", element, "") : "";
  const m = (modifier) => modifier ? _bem(unref$1(namespace), block, "", "", modifier) : "";
  const be = (blockSuffix, element) => blockSuffix && element ? _bem(unref$1(namespace), block, blockSuffix, element, "") : "";
  const em = (element, modifier) => element && modifier ? _bem(unref$1(namespace), block, "", element, modifier) : "";
  const bm = (blockSuffix, modifier) => blockSuffix && modifier ? _bem(unref$1(namespace), block, blockSuffix, "", modifier) : "";
  const bem = (blockSuffix, element, modifier) => blockSuffix && element && modifier ? _bem(unref$1(namespace), block, blockSuffix, element, modifier) : "";
  const is = (name, ...args) => {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        ...
        _ctx.loading ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          _ctx.$slots.loading ? renderSlot(_ctx.$slots, "loading", { key: 0 }) : (openBlock(), createBlock(unref$1(ElIcon), {
            key: 1,
        ...
        ], 64)) : _ctx.icon || _ctx.$slots.icon ? (openBlock(), createBlock(unref$1(ElIcon), { key: 1 }, {
          default: withCtx(() => [
        ...
        _ctx.$slots.default ? (openBlock(), createElementBlock("span", {
          key: 2,
          class: normalizeClass({ [unref$1(ns).em("text", "expand")]: unref$1(shouldAddSpace) })
        }, [
          renderSlot(_ctx.$slots, "default")
        ...
        createElementVNode("header", {
          ...
          _ctx.showClose ? (openBlock(), createElementBlock("button", {
            ...
            createVNode(unref$1(ElIcon), {
              ...
              default: withCtx(() => [
                (openBlock(), createBlock(resolveDynamicComponent(_ctx.closeIcon || unref$1(Close))))
              ]),
              _: 1
            }, 8, ["class"])
            ...
            withDirectives(createVNode(unref$1(ElOverlay), {
              ...
              default: withCtx(() => [
                createElementVNode("div", {
                  ...
                  class: normalizeClass(`${unref$1(ns).namespace.value}-overlay-dialog`),
                  onClick: _cache[0] || (_cache[0] = (...args) => unref$1(overlayEvent).onClick && unref$1(overlayEvent).onClick(...args)),
                  onMousedown: _cache[1] || (_cache[1] = (...args) => unref$1(overlayEvent).onMousedown && unref$1(overlayEvent).onMousedown(...args)),
                  onMouseup: _cache[2] || (_cache[2] = (...args) => unref$1(overlayEvent).onMouseup && unref$1(overlayEvent).onMouseup(...args))
                }, [
                  createVNode(unref$1(ElFocusTrap), {
                    ...
                    default: withCtx(() => [
                      unref$1(rendered) ? (openBlock(), createBlock(ElDialogContent, {
                        key: 0,
...
const _sfc_main = {
  ...
  setup(__props, { expose, emit }) {
    ...
    function handleCreate() {
      localContent.value = lodash.exports.cloneDeep(unref(props.content));
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        renderSlot(_ctx.$slots, "trigger", { triggerMethod: handleCreate }, () => [
          createVNode(unref$1(ElButton), {
            type: isNotEmpty(unref$1(content)) ? "warning" : "primary",
            onClick: handleCreate
          }, {
            default: withCtx(() => [
              createTextVNode(toDisplayString(isNotEmpty(unref$1(content)) ? "\u7F16\u8F91" : "\u521B\u5EFA"), 1)
            ]),
            _: 1
          }, 8, ["type"])
        ]),
        createVNode(unref$1(ElDialog), {
          ...
          default: withCtx(() => [
            renderSlot(_ctx.$slots, "default", { content: localContent.value })
          ]),
          _: 3
        }, 8, ["modelValue"])
      ]);
