(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("lodash"), require("xlsx")) : typeof define === "function" && define.amd ? define(["exports", "lodash", "xlsx"], factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, factory(global2.commonVueCmp = {}, global2.lodash, global2.XLSX));
})(this, function(exports2, lodash, XLSX) {
  "use strict";
...
usage: app.provide(ID_INJECTION_KEY, {
  ...
  var Button = /* @__PURE__ */ _export_sfc$1(_sfc_main$5, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/button/src/button.vue"]]);
  ...
  var ButtonGroup = /* @__PURE__ */ _export_sfc$1(_sfc_main$4, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/button/src/button-group.vue"]]);
  ...
  var ElDialogContent = /* @__PURE__ */ _export_sfc$1(_sfc_main$3, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/dialog/src/dialog-content.vue"]]);
  ...
  var Dialog = /* @__PURE__ */ _export_sfc$1(_sfc_main$2, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/dialog/src/dialog.vue"]]);
  ...
  const _sfc_main$1 = defineComponent({
    ...
    setup(props) {
      ...
      function handleCreate() {
        localContent.value = lodash.cloneDeep(unref(props.content));
  ...
  const _hoisted_1$1 = /* @__PURE__ */ createTextVNode(" \u5F39\u7A97\u7EC4\u4EF6\u5185\u5BB9 ");
  ...
  const DialogInstance = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1]]);
  defineComponent({
    components: { ElButton, ElDialog },
    props: {
      buttonName: { type: String, default: "\u521B\u5EFA" },
    ...
    setup(props, { emit: emit2 }) {
      ...
      function getHeaderRow(sheet) {
        if (!sheet || !sheet["!ref"])
          return [];
        const headers = [];
        const range = XLSX__namespace.utils.decode_range(sheet["!ref"]);
        const R = range.s.r;
        for (let C = range.s.c; C <= range.e.c; ++C) {
          const cell = sheet[XLSX__namespace.utils.encode_cell({ c: C, r: R })];
          let hdr = `UNKNOWN ${C}`;
          if (cell && cell.t)
            hdr = XLSX__namespace.utils.format_cell(cell);
          headers.push(hdr);
        }
        return headers;
      }
      function getExcelData(workbook) {
        ...
        for (const sheetName of workbook.SheetNames) {
          ...
          let results = XLSX__namespace.utils.sheet_to_json(worksheet, {
            raw: true,
            dateNF: dateFormat,
          });
        ...
        return new Promise((resolve2, reject) => {
          ...
          reader.onload = async (e) => {
            try {
              ...
              const workbook = XLSX__namespace.read(data, { type: "array", cellDates: true });
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("div", null, [
      withDirectives(createBaseVNode("input", {
        ...
        type: "file",
        accept: ".xlsx, .xls",
        onChange: _cache[0] || (_cache[0] = (...args) => _ctx.handleInputClick && _ctx.handleInputClick(...args)),
      }, null, 544), [
        [vShow, false],
      ]),
      createBaseVNode("div", {
        onClick: _cache[1] || (_cache[1] = (...args) => _ctx.handleUpload && _ctx.handleUpload(...args)),
      }, [
        renderSlot(_ctx.$slots, "default", {}, () => [
          _hoisted_1,
        ]),
  ...
  const index = "";
  exports2.DialogInstance = DialogInstance;
  exports2.ImportExcel = ImportExcel;
